...
public class CreateVideoAddAudioToMp4_ViewBinding implements Unbinder {
  private CreateVideoAddAudioToMp4 target;
  ...
  @UiThread
  public CreateVideoAddAudioToMp4_ViewBinding(CreateVideoAddAudioToMp4 target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CreateVideoAddAudioToMp4_ViewBinding(final CreateVideoAddAudioToMp4 target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CreateVideoAddAudioToMp4 target = this.target;
