...
public class CreatMusicVideoByMediaCodecActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public CreatMusicVideoByMediaCodecActivity_ViewBinding(CreatMusicVideoByMediaCodecActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CreatMusicVideoByMediaCodecActivity_ViewBinding(final CreatMusicVideoByMediaCodecActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CreatMusicVideoByMediaCodecActivity target = this.target;
